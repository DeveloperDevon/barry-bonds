import { Box, Group, Stack, Table, Tabs, Text, Title } from "@mantine/core"
...
const clean = [
  ...
  { player: 'Willy Mays', battingAvg: 0.302, rbis: 1903, hrs: 660, slugging: 0.557, obs: 0.941, hits: 3283 },
]
    ...
    <Stack p='sm'>
      ...
      <Tabs defaultValue="steroids">
        ...
        <Tabs.Panel value="steroids">
          ...
          <Text> Barry bonds played in the so called “steriod eara” where many MLB players where using growth hormones and preforming enhancing drugs to improve their play in baseball. </Text>
          <Table my={15}>
            <Table.Thead>
              <Table.Tr>
          ...
          <Group wrap='nowrap'>
            ...
            <Stack>
              <Text mb={15}> Compared to these other five athletes in the steroid era Barry bonds leads them in the following stats RBIS, HR, Slugging, and Obs. These five athletes all tested positive for performance enhancing drugs during this era. Barry bonds had a lot of evidence agasint him hinting at that fact he used performing enhancing drugs but he never actually tested postitive.</Text>
              ...
              <Text fw='bold'>Statistically Barry Bonds is the best played in the “steroid era”</Text>
            </Stack>
          </Group>
        </Tabs.Panel>
        ...
        <Tabs.Panel value="clean">
          ...
          <Text>These five athletes all played in times when players where “clean” meaning people where not using preforming enhancing drugs at the time.</Text>
          <Table my={15}>
            <Table.Thead>
              <Table.Tr>
                <Table.Th>Players</Table.Th>
          ...
          <Group wrap='nowrap'>
            <Box>
              <Text mb={15}>Compared to these other five athletes Barry Bonds is the leader in the following stats RBIs, HR, Slugging, Obs. </Text>
              <Text>These five other athletes are all in the hall of fame and considered to be the “all times greats” of baseball. But statistically overall barry bonds is better then all of them except for potently willie mays, and babe ruth who are considered to be the Goats of baseball.</Text>
            </Box>
            <Box>
        ...
        <Tabs.Panel value='accolades'>
          ...
          <Group wrap='nowrap'>
            <Box>
              <Text mb={15}>Barry Bonds won 7 NL MVPs making him have the most mvps by 4 second closest being a tie between many people at 3.</Text>
              <Text mb={15}>He was also a 14 time allstar meaning he was one of the best players in the league in fourteen different years.</Text>
              <Text mb={15}>He won 12 silver sluggers also being the most ever in the MLB history.</Text>
              <Text mb={15}>Won the Hank Aaron award three times.</Text>
              <Text mb={15}>All time home run leader.</Text>
              <Text mb={15}>All time National league RBI holder.</Text>
              <Text mb={15} fw='bold'>Statistically Barry Bonds has proven himself to be top three baseball players of all time and 100% statistically should be in the hall of fame.</Text>
            </Box>
            <Box>
