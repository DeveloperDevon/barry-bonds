    ...
    <Stack p='sm'>
      ...
      <Tabs defaultValue="steroids">
        ...
        <Tabs.Panel value="steroids">
          ...
          <Text> Barry Bonds played in the so called "steriod era" where many MLB players were using growth hormones and preforming enhancing drugs to improve their play in baseball. </Text>
          <Table my={15}>
            <Table.Thead>
              <Table.Tr>
        ...
        <Tabs.Panel value='accolades'>
          ...
          <Group wrap='nowrap'>
            <List>
              ...
              <ListItem mb={15} fw='bold'>Statistically Barry Bonds has proven himself to be top three baseball players of all time and 100% statistically should be in the hall of fame.</ListItem>
            </List>
            <Box>
